...
Class Mongo_db {
    ...
    function __construct($param) {
        ...
        $this->mongo_exception = $this->CI->config->item('mongo_exception');
        $this->param = $param;
        $this->connect();
    }
    ...
    private function connect() {
        ...
        try {
            ...
            if($this->mongo_exception == TRUE)
            {
                iredirect('signup/error_404');
            }
    ...
    public function insert($collection = "", $insert = array()) {
      ...
      //  $writeConcern = new MongoDB\Driver\WriteConcern(MongoDB\Driver\WriteConcern::MAJORITY, 1000);
        ...
        try {
            $write = $this->db->executeBulkWrite($this->database . "." . $collection, $bulk);
    ...
    public function batch_insert($collection = "", $insert = array()) {
      ...
      //  $writeConcern = new MongoDB\Driver\WriteConcern(MongoDB\Driver\WriteConcern::MAJORITY, 1000);
        ...
        try {
            $result = $this->db->executeBulkWrite($this->database . "." . $collection, $doc);
            return $result;
        }
        // Check if the write concern could not be fulfilled
        catch (MongoDB\Driver\Exception\BulkWriteException $e) {
    ...
    public function manager_command($collection = null, $filterdata  = null)
    {
        ...
        return $this->connect->executeCommand($this->database, $command);
    }
